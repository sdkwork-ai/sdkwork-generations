...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 14 | `generations-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 14 | `generations-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 14 | `generations-staging.sdkwork.com` | 80 |
| production | `server.production.toml` | 14 | `generations.sdkwork.com` | 443 ssl + 80 |
