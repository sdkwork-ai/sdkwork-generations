...
Module `sdkwork-generations` · runtime code `generations` · enabled
...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 16 | `generations-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 16 | `generations-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 16 | `generations-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 16 | `generations-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 16 | `generations.sdkwork.com` | 443 ssl + 80 |
