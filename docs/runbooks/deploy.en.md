# Runbook — sdkwork-generations deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-generations-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-generations/bundle`, loads the image, starts
